...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Section className="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500 border border-gray-100">
              ...
              <div className="p-8 bg-gradient-to-r from-gray-900 to-black text-center">
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold text-blue-300 text-center mb-16">
              OUR MISSION
            </h2>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <div className="bg-blue-600 rounded-lg p-8 shadow-2xl transform hover:scale-105 transition-all duration-300 h-full flex flex-col">
            ...
            {/* Become a Volunteer */}
            <div className="bg-green-500 rounded-lg p-8 shadow-2xl transform hover:scale-105 transition-all duration-300 h-full flex flex-col">
              <h3 className="text-white text-xl font-bold mb-4 leading-tight">
                Become a Volunteer
              </h3>
              <p className="text-white/90 mb-6 flex-1">
            ...
            <div className="bg-gray-700 rounded-lg p-8 shadow-2xl transform hover:scale-105 transition-all duration-300 h-full flex flex-col">
              <h3 className="text-white text-xl font-bold mb-4 leading-tight">
                Contribute Financially
              </h3>
              <p className="text-white/90 mb-6 flex-1">
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-400 mb-4 flex justify-center items-center">
                <span
                  className="animate-number w-20 text-right"
                  data-target="37"
                >
                  0
                </span>
                <span className="ml-2">million</span>
              </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white text-lg">People waiting for a kidney</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white text-lg">People die per day waiting</p>
            </div>
          </div>
        </Container>
      </section>
      ...
      {/* Be A Hero Section */}
      <Section className="py-20 bg-gradient-to-r from-forest-600 to-sage-600 text-white">
        <Container>
          <div className="text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Be A Hero</h2>
            <h3 className="text-2xl font-bold mb-8">You could Save a Life</h3>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Patients need help. Most kidney patients are destitute because
              they often don't have the energy to work and their medical bills
              have added up. Every dollar you give will go toward helping
              patients by supporting our programs that are designed to increase
            ...
            <Button
              ...
              variant="primary"
              size="lg"
              className="bg-white text-forest-900 hover:bg-gray-100"
            >
              Contribute Now
            </Button>
          </div>
