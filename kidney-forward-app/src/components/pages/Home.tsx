    ...
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">
              Welcome to Kidney Forward
            </h1>
            <p className="text-xl mb-8">
              Empowering kidney patients and promoting organ donation awareness through education, support, and community engagement.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive resources and support for kidney patients throughout their journey.
              </p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Donor Registry</h3>
              <p className="text-gray-600">
                Join our donor registry and help save lives through organ donation.
              </p>
              <Link to="/donor-registration" className="text-blue-600 hover:underline mt-2 inline-block">
                Register Now →
              </Link>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Educational courses and resources for patients, donors, and healthcare professionals.
              </p>
      ...
      <section className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Join our community and help us support kidney patients across the nation.
          </p>
          <Link
            to="/get-involved"
